...
START_TEST(test17) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I'm %0.0e years old", 31.);
  sprintf(buffer2, "I'm %0.0e years old", 31.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test53) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I'm %0.e years old", 31.);
  sprintf(buffer2, "I'm %0.e years old", 31.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test73) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I'm %20.0e years old", 31.);
  sprintf(buffer2, "I'm %20.0e years old", 31.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
Suite *s21_sprintf_test_suite_specifier_e_3() {
  Suite *s = suite_create("\033[42m-=s21_sprintf test specifier e_3=-\033[0m");
