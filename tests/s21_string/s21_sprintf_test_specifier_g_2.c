...
START_TEST(test3) {
  char buffer1[8000] = {'\0'};
  char buffer2[8000] = {'\0'};
  s21_sprintf(buffer1, "I'm %15g years old", 123.312);
  sprintf(buffer2, "I'm %15g years old", 123.312);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test25) {
  char buffer1[8000] = {'\0'};
  char buffer2[8000] = {'\0'};
  s21_sprintf(buffer1, "I'm %0g years old", 123.312);
  sprintf(buffer2, "I'm %0g years old", 123.312);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test27) {
  char buffer1[8000] = {'\0'};
  char buffer2[8000] = {'\0'};
  s21_sprintf(buffer1, "I'm %015G years old", 123.312);
  sprintf(buffer2, "I'm %015G years old", 123.312);
  ck_assert_str_eq(buffer1, buffer2);
}
...
Suite *s21_sprintf_test_suite_specifier_g_2() {
  Suite *s = suite_create("\033[42m-=s21_sprintf test specifier g_2=-\033[0m");
