...
START_TEST(test1) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %f years old", 123.456);
  sprintf(buffer2, "I'm %f years old", 123.456);
...
START_TEST(test5) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %#f years old", 123.);
  sprintf(buffer2, "I'm %#f years old", 123.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test7) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %0f years old", 123.456);
  sprintf(buffer2, "I'm %0f years old", 123.456);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test9) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %0 f years old", 123.456);
  sprintf(buffer2, "I'm %0 f years old", 123.456);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test19) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %10f years old", 123.456);
  sprintf(buffer2, "I'm %10f years old", 123.456);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test23) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %#10f years old", 123.);
  sprintf(buffer2, "I'm %#10f years old", 123.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test25) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %010f years old", 123.456);
  sprintf(buffer2, "I'm %010f years old", 123.456);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test27) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %0 10f years old", 123.456);
  sprintf(buffer2, "I'm %0 10f years old", 123.456);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test49) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %-10f years old", 0.00123456789);
  sprintf(buffer2, "I'm %-10f years old", 0.00123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test51) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %.8f years old", -0.00000123456789);
  sprintf(buffer2, "I'm %.8f years old", -0.00000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test52) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %.12f years old", -0.00000123456789);
  sprintf(buffer2, "I'm %.12f years old", -0.00000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}

Suite *s21_sprintf_test_suite_specifier_f_1() {
  Suite *s = suite_create("\033[42m-=s21_sprintf test specifier f_1=-\033[0m");
