...
START_TEST(test1) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I'm %.15e years old", 0.0000000000000123456789);
  sprintf(buffer2, "I'm %.15e years old", 0.0000000000000123456789);
...
START_TEST(test17) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I'm %0.15e years old", 0.0000000000000123456789);
  sprintf(buffer2, "I'm %0.15e years old", 0.0000000000000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test37) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I'm %20.15e years old", 0.0000000000000123456789);
  sprintf(buffer2, "I'm %20.15e years old", 0.0000000000000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test53) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I'm %020.15e years old", 0.0000000000000123456789);
  sprintf(buffer2, "I'm %020.15e years old", 0.0000000000000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test89) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %E years old", 0.00009);
  sprintf(buffer2, "I'm %E years old", 0.00009);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test90) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  sprintf(buffer1, "I'm %LE years old", 1.79769e+609L);
  sprintf(buffer2, "I'm %LE years old", 1.79769e+609L);
  ck_assert_str_eq(buffer1, buffer2);
}

Suite *s21_sprintf_test_suite_specifier_e_9() {
  Suite *s = suite_create("\033[42m-=s21_sprintf test specifier e_9=-\033[0m");
