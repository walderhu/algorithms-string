...
START_TEST(test1) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %20.3f years old", 16384.32768);
  sprintf(buffer2, "I'm %20.3f years old", 16384.32768);
...
START_TEST(test9) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %020.3f years old", 16384.32768);
  sprintf(buffer2, "I'm %020.3f years old", 16384.32768);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test23) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %20.0f years old", 0.);
  sprintf(buffer2, "I'm %20.0f years old", 0.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test31) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %020.0f years old", 0.);
  sprintf(buffer2, "I'm %020.0f years old", 0.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test37) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %20.f years old", 0.);
  sprintf(buffer2, "I'm %20.f years old", 0.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test45) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %020.f years old", 0.);
  sprintf(buffer2, "I'm %020.f years old", 0.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test55) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %20.f years old", 16384.32768);
  sprintf(buffer2, "I'm %20.f years old", 16384.32768);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test63) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I'm %020.f years old", 16384.32768);
  sprintf(buffer2, "I'm %020.f years old", 16384.32768);
  ck_assert_str_eq(buffer1, buffer2);
}
...
Suite *s21_sprintf_test_suite_specifier_f_4() {
  Suite *s = suite_create("\033[42m-=s21_sprintf test specifier f_4=-\033[0m");
